<?php
    ...
    class Router{
        ...
        public function cargarRutas(){
            $this ->routes["/"] = ["controller" => "HomeControllers", "action" => "indexCookie"];
            ...
            $this ->routes["/login"] = ["controller" => "HomeControllers", "action" => "login"];
            $this ->routes["/loginCookie"] = ["controller" => "HomeControllers", "action" => "loginCookie"];
            $this ->routes["/logout"] = ["controller" => "HomeControllers", "action" => "logout"];
            $this ->routes["/logoutCookie"] = ["controller" => "HomeControllers", "action" => "logoutCookie"];
