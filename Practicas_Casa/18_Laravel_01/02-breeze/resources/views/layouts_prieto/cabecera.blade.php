<header class="d-flex flex-wrap align-items-center justify-content-between py-2 px-4 border-bottom shadow-sm bg-light sticky-top">
    ...
    <div class="col-md-4 text-end d-flex align-items-center justify-content-end gap-2">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('ordersShow') }}">Mostrar pedidos</a></li>
                <li>
