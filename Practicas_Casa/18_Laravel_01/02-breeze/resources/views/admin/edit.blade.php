        ...
        <div class="col-md-6">
            <form method="POST" action="{{ route('admin.products.update', $producto->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="available" name="available" {{ old('available', $producto->available) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="product_type" name="product_type" value="{{ old('product_type', $producto->product_type) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if($producto->image)
                        ...
                        <img src="{{ asset($producto->image) }}" alt="Imagen del producto" class="img-fluid mt-2" style="max-height:100px; object-fit:contain;">
                    @endif
                </div>
