<?php
    ...
    class Router{
        ...
        public function cargarRutas(){
            ...
            $this ->routes["/register"] = ["controller" => "HomeControllers", "action" => "register"];
            $this ->routes["/register2"] = ["controller" => "HomeControllers", "action" => "register2"];
            $this ->routes["/logOut"] = ["controller" => "HomeControllers", "action" => "logOut"];
            $this ->routes["/compra"] = ["controller" => "HomeControllers", "action" => "compra"];
        }
